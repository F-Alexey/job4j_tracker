...
public class AnalyzeByMap {
    ...
    public static Label bestStudent(List<Pupil> pupils) {
        ...
        return answer.get(answer.size() - 1); // если использовать getLast() - падает в ошибку cannot find symbol
    }
    ...
    public static Label bestSubject(List<Pupil> pupils) {
        ...
        return result.get(result.size() - 1); // если использовать getLast() - падает в ошибку cannot find symbol
    }
